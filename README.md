...
A collection of AWS service documentation and study notes — basic to advanced.
...
| **Athena**     | Serverless SQL query engine on S3 data               | [Athena/Readme.md](./Athena/Readme.md) |
